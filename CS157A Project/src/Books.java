...
public class Books {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/books?autoReconnet=true&useSSL=false";
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            stmt.executeUpdate("DROP DATABASE books");
            ...
            Connection myConn = DriverManager.getConnection("jdbc:mysql://localhost:3306/books?autoReconnet=true&useSSL=false" , USER , PASS);
            ...
            String sqlAuthor = "SELECT * FROM Books.authors ORDER BY last ASC";
            ...
            rs= stmt.executeQuery(sqlAuthor);
            ...
            System.out.println();
            //for(int i =1; i<15; i++){
                //ResultSet query3 = queryPrinter.getResultSet("SELECT title, isbn, year FROM books.titles WHERE publisherID ="+i+"");
            		ResultSet query3 = queryPrinter.getResultSet("SELECT title, isbn, year FROM books.titles ORDER BY title ASC");
                while(query3.next()){
                    System.out.println(query3.getString("title") + " , " +  query3.getString("isbn") + " , " +  query3.getString("year"));
                }
            ...
            queryPrinter.setResult("INSERT INTO books.authors (first, last) VALUES ('Derek', 'Lin');");
            // Print out author table with the recently added Author
            /*System.out.println("For the query: Add new author");
            System.out.println();
            System.out.println("The records selected are:");
            System.out.println();*/
            System.out.println("Derek Lin added into authors.");
            ...
            queryPrinter.setResult("UPDATE books.authors SET first = \"Derek\", last = \"Lin\" WHERE authorID = 1");
            ...
            queryPrinter.setResult("INSERT INTO books.publishers (publisherName) VALUES (\"Derek\");");
            ...
            queryPrinter.setResult("UPDATE books.publishers SET publisherName = \"Alvin\" WHERE publisherID = 8;");
            System.out.println("For the update: Edit/Update the existing information about an author");
            System.out.println();
            System.out.println("The updated records are:");
            System.out.println();
